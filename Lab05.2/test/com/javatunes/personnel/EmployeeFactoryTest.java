...
public class EmployeeFactoryTest
{
    ...
    public void testCreateEmployeeSalaried()
    {
        ...
        assertEquals(Double.valueOf(50000.0),semp.getSalary()); // Double vs double
    }
    ...
    public void testCreateEmployeeHourly()
    {
        ...
        assertEquals(Double.valueOf(50.0),hemp.getRate());
        assertEquals(Double.valueOf(40.0),hemp.getHours());
    }
    ...
    {
      // create map with an invalid value for the "type" entry
      Map<String,String> invalidMap = Map.of("type", "-INVALID-");

      // make the business call to the factory
      Employee emp = EmployeeFactory.createEmployee(invalidMap);

      // what should be true? / what should happen when this call above executes
