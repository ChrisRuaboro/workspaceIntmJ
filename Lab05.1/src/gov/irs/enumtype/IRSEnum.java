...
{
    INSTANCE;
    // EVERYTHING FROM HERE ON DOWN IS ONLY HERE FOR LEARNING PURPOSES
    // ESSENTIALLY I'M JUST WRITING WHEN STUFF GETS LOADED
    ...
    // with this in place, client code could look like this
    // IRSEnum.Instance()
