...
public class TelevisionTest
{
    ...
    {  // throws clause needed because it's an unhandled checked exception
        Television tv = new Television();
    ...
    public void testChangeChannelInvalidChannelException_LowerBound() throws InvalidChannelException
    ...
    @Test(expected = InvalidChannelException.class)
    public void testChangeChannelInvalidChannelException_UpperBound() throws InvalidChannelException
    {  // unhandled checked exception
        Television tv = new Television();
    ...
    { // natural order defined by brand only
