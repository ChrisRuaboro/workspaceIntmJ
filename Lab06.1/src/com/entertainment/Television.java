...
public class Television implements Comparable<Television>
{
    ...
    public void setVolume(int volume) throws IllegalArgumentException
    {
        if (volume >= MIN_VOLUME && volume <= MAX_VOLUME) {
            ...
            throw new IllegalArgumentException("Invalid volume: " + volume + ". " + "Allowed range: [" + MIN_VOLUME + "," + MAX_VOLUME + "].");
        }
    }
    ...
    public void changeChannel(int channel) throws InvalidChannelException
    {
        if (channel >= MIN_CHANNEL && channel <= MAX_CHANNEL) {
            ...
            throw new InvalidChannelException("Invalid channel: " + channel + ". " + "Allowed range: [" + MIN_CHANNEL + "," + MAX_CHANNEL + "].");
        }
    }
    ...
    {
        return getClass().getSimpleName() + " [brand=" + getBrand() + ", volume=" + getVolume() + ", currentChannel=" + getCurrentChannel() + ", display=" + getDisplay() + "]";
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj instanceof Television) {
            ...
            result = Objects.equals(this.getBrand(), other.getBrand()) && Objects.equals(this.getVolume(), other.getVolume()) && Objects.equals(this.getDisplay(), other.getDisplay());
        }
        return result;
    }
